  ...
  const staticSoftwareList = [
    {
      ...
      introduction:
        "专业的图像编辑和设计软件，提供强大的图像处理功能和创意工具，是设计师和摄影师的首选工具。",
    ...
    },
    {
      ...
      introduction:
        "完整的办公套件，包含Word、Excel、PowerPoint等应用，支持云端协作和多设备同步。",
    ...
    },
    {
      ...
      introduction:
        "免费的代码编辑器，支持多种编程语言，拥有丰富的插件生态系统，是开发者的理想选择。",
    ...
    },
    {
      ...
      name: "AutoCAD 2024",
      introduction:
        "业界领先的CAD设计软件，适用于2D和3D设计，广泛应用于建筑、工程和制造业。",
    ...
    },
    {
      ...
      name: "Figma Pro",
      introduction:
        "现代化的UI/UX设计工具，支持实时协作，是团队设计项目的最佳选择。",
